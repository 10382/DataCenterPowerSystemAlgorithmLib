...
_POWEREVALUATEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='targetTimestamp', full_name='powerevaluate.PowerEvaluateRequest.targetTimestamp', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='algorithm', full_name='powerevaluate.PowerEvaluateRequest.algorithm', index=2,
